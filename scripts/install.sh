...
git clone https://github.com/varigit/omapzoom-mirror-platform-hardware-ti-wlan.git ${ANDROID_DIR}/hardware/ti/wlan
...
git clone https://github.com/varigit/omapzoom-mirror-platform-hardware-ti-wpan.git ${ANDROID_DIR}/hardware/ti/wpan
...
git clone https://github.com/varigit/omapzoom-mirror-platform-external-crda.git ${ANDROID_DIR}/external/crda
