...
#
# Variscite patches for Android 15.0.0 2.0.0
...
readonly BASE_BRANCH_NAME="android-15.0.0_2.0.0"

## git variables get from base script!
readonly _EXTPARAM_BRANCH="android-15.0.0_2.0.0-var01"
...
############### main code ##############
pr_info "Script version ${SCRIPT_VERSION} (g:20251017)"
