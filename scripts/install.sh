...
git clone https://github.com/varigit/omapzoom-mirror-platform-hardware-ti-wlan.git ${VENDOR_BASE_DIR}/wlan
...
git clone https://github.com/varigit/omapzoom-mirror-platform-hardware-ti-wpan.git ${VENDOR_BASE_DIR}/wpan
...
git clone https://github.com/varigit/omapzoom-mirror-platform-external-crda.git ${VENDOR_BASE_DIR}/crda
