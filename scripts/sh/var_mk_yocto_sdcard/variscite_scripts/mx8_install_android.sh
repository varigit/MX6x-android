...
do
	...
	if [[ "$img" == *"imx8mp-var-som-symphony-hdmi"* ]]; then
		...
		img_list+=("$img (Variscite VAR-SOM-MX8M-PLUS with Basler camera on Symphony-Board)")
		...
		img_list+=("$img (Variscite DART-MX8M-PLUS with Basler camera DT8MCustomBoard 2.x)")
