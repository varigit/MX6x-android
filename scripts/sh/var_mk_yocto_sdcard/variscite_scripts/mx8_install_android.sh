...
function add_imx8mp_menu() {
	...
	img_list+=("dtbo-imx8mp-var-dart-wbe-sonata-basler-isi0.img             (DART-MX8M-PLUS V2.x with WBE and Basler VCAM-AR1335B camera support on Sonata-Board)")
	img_list+=("dtbo-imx8mp-var-dart-wbe-sonata-basler-isi0-m7.img          (DART-MX8M-PLUS V2.x with WBE, Basler VCAM-AR1335B camera and M7 support on Sonata-Board)")
	img_list+=("dtbo-imx8mp-var-dart-wbe-sonata-basler-isp0.img             (DART-MX8M-PLUS V2.x with WBE and Basler VCAM-AR0821B camera support on Sonata-Board)")
	img_list+=("dtbo-imx8mp-var-dart-wbe-sonata-basler-isp0-m7.img          (DART-MX8M-PLUS V2.x with WBE, Basler VCAM-AR0821B camera and M7 support on Sonata-Board)")
	img_list+=("dtbo-imx8mp-var-dart-wbe-sonata.img                         (DART-MX8M-PLUS V2.x with WBE support on Sonata-Board)")
	img_list+=("dtbo-imx8mp-var-dart-wbe-sonata-m7.img                      (DART-MX8M-PLUS V2.x with WBE and M7 support on Sonata-Board)")
	...
	img_list+=("dtbo-imx8mp-var-dart-1.x-sonata-basler-isi0.img             (DART-MX8M-PLUS V1.x with Basler VCAM-AR1335B camera support on Sonata-Board)")
	img_list+=("dtbo-imx8mp-var-dart-1.x-sonata-basler-isi0-m7.img          (DART-MX8M-PLUS V1.x with Basler VCAM-AR1335B camera and M7 support on Sonata-Board)")
	img_list+=("dtbo-imx8mp-var-dart-1.x-sonata-basler-isp0.img             (DART-MX8M-PLUS V1.x with Basler VCAM-AR0821B camera support on Sonata-Board)")
	img_list+=("dtbo-imx8mp-var-dart-1.x-sonata-basler-isp0-m7.img          (DART-MX8M-PLUS V1.x with Basler VCAM-AR0821B camera and M7 support on Sonata-Board)")
	img_list+=("dtbo-imx8mp-var-dart-1.x-sonata.img                         (DART-MX8M-PLUS V1.x support on Sonata-Board)")
	img_list+=("dtbo-imx8mp-var-dart-1.x-sonata-m7.img                      (DART-MX8M-PLUS V1.x with M7 support on Sonata-Board)")
	img_list+=("dtbo-imx8mp-var-som-symphony-2nd-ov5640-m7.img              (VAR-SOM-MX8M-PLUS V2.x with LVDS, 2nd OV5640 and M7 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-2nd-ov5640.img                 (VAR-SOM-MX8M-PLUS V2.x with LVDS and 2nd OV5640 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-basler-isp0.img                (VAR-SOM-MX8M-PLUS V2.x with LVDS and Basler VCAM-AR0821B camera support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-basler-isp0-m7.img             (VAR-SOM-MX8M-PLUS V2.x with LVDS, Basler VCAM-AR0821B camera and M7 supporton Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-basler-isi0.img                (VAR-SOM-MX8M-PLUS V2.x with LVDS and Basler VCAM-AR1335B camera support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-basler-isi0-m7.img             (VAR-SOM-MX8M-PLUS v2.X with LVDS, Basler VCAM-AR1335B camera and M7 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-m7.img                         (VAR-SOM-MX8M-PLUS V2.X with LVDS and M7 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony.img                            (VAR-SOM-MX8M-PLUS V2.X with LVDS support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-2nd-ov5640-m7.img          (VAR-SOM-MX8M-PLUS V1.x with LVDS, 2nd OV5640 and M7 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-2nd-ov5640.img             (VAR-SOM-MX8M-PLUS V1.x with LVDS and 2nd OV5640 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-basler-isp0.img            (VAR-SOM-MX8M-PLUS V1.x with LVDS and Basler VCAM-AR0821B camera support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-basler-isp0-m7.img         (VAR-SOM-MX8M-PLUS V1.x with LVDS, Basler VCAM-AR0821B camera and M7 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-basler-isi0.img            (VAR-SOM-MX8M-PLUS V1.x with LVDS and Basler VCAM-AR1335B camera support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-basler-isi0-m7.img         (VAR-SOM-MX8M-PLUS V1.x with LVDS, Basler VCAM-AR1335B camera and M7 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-m7.img                     (VAR-SOM-MX8M-PLUS V1.x with LVDS and M7 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony.img                        (VAR-SOM-MX8M-PLUS V1.x with LVDS support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-2nd-ov5640-m7.img          (VAR-SOM-MX8M-PLUS V2.X with WBE, LVDS, 2nd OV5640 and M7 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-2nd-ov5640.img             (VAR-SOM-MX8M-PLUS V2.x with WBE, LVDS and 2nd OV5640 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-basler-isp0.img            (VAR-SOM-MX8M-PLUS V2.x with WBE, LVDS and Basler VCAM-AR0821B camera support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-basler-isp0-m7.img         (VAR-SOM-MX8M-PLUS V2.x with WBE, LVDS, Basler VCAM-AR0821B camera and M7 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-basler-isi0.img            (VAR-SOM-MX8M-PLUS V2.x with WBE, LVDS and Basler VCAM-AR1335B camera support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-basler-isi0-m7.img         (VAR-SOM-MX8M-PLUS V2.x with WBE, LVDS, Basler VCAM-AR1335B camera and M7 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-m7.img                     (VAR-SOM-MX8M-PLUS V2.x with WBE, LVDS and M7 support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony.img                        (VAR-SOM-MX8M-PLUS V2.x with WBE and LVDS support on Symphony-Board V2.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-1.x-2nd-ov5640.img         (VAR-SOM-MX8M-PLUS V1.x with LVDS and 2nd OV5640 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-1.x-2nd-ov5640-m7.img      (VAR-SOM-MX8M-PLUS V1.x with LVDS, 2nd OV5640 and M7 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-1.x-basler-isi0.img        (VAR-SOM-MX8M-PLUS V1.x with LVDS and Basler VCAM-AR1335B camera support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-1.x-basler-isi0-m7.img     (VAR-SOM-MX8M-PLUS V1.x with LVDS, Basler VCAM-AR1335B camera and M7 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-1.x-basler-isp0.img        (VAR-SOM-MX8M-PLUS V1.x with LVDS and Basler VCAM-AR0821B camera support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-1.x-basler-isp0-m7.img     (VAR-SOM-MX8M-PLUS V1.x with LVDS, Basler VCAM-AR0821B camera and M7 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-1.x.img                    (VAR-SOM-MX8M-PLUS V1.x with LVDS support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-1.x-symphony-1.x-m7.img                 (VAR-SOM-MX8M-PLUS V1.x with LVDS and M7 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-1.x-2nd-ov5640.img             (VAR-SOM-MX8M-PLUS V2.x with LVDS and 2nd OV5640 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-1.x-2nd-ov5640-m7.img          (VAR-SOM-MX8M-PLUS V2.x with LVDS, 2nd OV5640 and M7 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-1.x-basler-isi0.img            (VAR-SOM-MX8M-PLUS V2.x with LVDS and Basler VCAM-AR1335B camera support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-1.x-basler-isi0-m7.img         (VAR-SOM-MX8M-PLUS V2.x with LVDS, Basler VCAM-AR1335B camera and M7 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-1.x-basler-isp0.img            (VAR-SOM-MX8M-PLUS V2.x with LVDS and Basler VCAM-AR0821B camera support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-1.x-basler-isp0-m7.img         (VAR-SOM-MX8M-PLUS V2.x with LVDS, Basler VCAM-AR0821B camera and M7 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-1.x.img                        (VAR-SOM-MX8M-PLUS V2.x with LVDS support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-symphony-1.x-m7.img                     (VAR-SOM-MX8M-PLUS V2.x with LVDS and M7 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-1.x-2nd-ov5640.img         (VAR-SOM-MX8M-PLUS V2.x with WBE, LVDS and 2nd OV5640 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-1.x-2nd-ov5640-m7.img      (VAR-SOM-MX8M-PLUS V2.x with WBE, LVDS, 2nd OV5640 and M7 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-1.x-basler-isi0.img        (VAR-SOM-MX8M-PLUS V2.x with WBE, LVDS and Basler VCAM-AR1335B camera support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-1.x-basler-isi0-m7.img     (VAR-SOM-MX8M-PLUS V2.x with WBE, LVDS, Basler VCAM-AR1335B camera and M7 support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mp-var-som-wbe-symphony-1.x-basler-isp0.img        (VAR-SOM-MX8M-PLUS V2.x with WBE, LVDS and Basler VCAM-AR0821B camera support on Symphony-Board V1.x)")
...
function add_imx8mm_menu() {
	...
	img_list+=("dtbo-imx8mm-var-som-symphony-1.x.img		(VAR-SOM-MX8M-MINI V2.x on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mm-var-som-symphony-1.x-m4.img		(VAR-SOM-MX8M-MINI V2.x with M4 support on Symphony-Board V1.x)")
	...
	img_list+=("dtbo-imx8mm-var-som-1.x-symphony-1.x.img		(VAR-SOM-MX8M-MINI V1.x on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mm-var-som-1.x-symphony-1.x-m4.img		(VAR-SOM-MX8M-MINI V1.x with M4 support on Symphony-Board V1.x)")
	...
	img_list+=("dtbo-imx8mm-var-som-wbe-symphony-1.x.img		(VAR-SOM-MX8M-MINI V2.x with WBE support on Symphony-Board V1.x)")
	img_list+=("dtbo-imx8mm-var-som-wbe-symphony-1.x-m4.img		(VAR-SOM-MX8M-MINI V2.x with WBE and M4 support on Symphony-Board V1.x)")
	...
	do
		if [[ -z "$opt" ]] ; then
			...
			if grep -q "i.MX8MM\|i.MX8MN\|i.MX8MQ\|i.MX8MP\|i.MX8QM\|i.MX8QP\|i.MX8QXP" /sys/devices/soc0/soc_id; then
				...
				# Remove .img extension and dtbo- prefix
				soc_name=`echo $dtbo_img | sed 's/\.img$//' | sed "s/${img_prefix}//"`
			else
				soc_name=$opt
			fi
