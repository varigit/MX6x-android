...
define build_imx_uboot
	...
	cp $(UBOOT_OUT)/arch/arm/dts/fsl-imx8mq-var-dart.dtb  $(IMX_MKIMAGE_PATH)/imx-mkimage/iMX8M/fsl-imx8mq-evk.dtb; \
	...
	cp $(IMX_MKIMAGE_PATH)/imx-mkimage/iMX8M/flash.bin $(PRODUCT_OUT)/u-boot-$(strip $(2))-dp.imx;
endef
