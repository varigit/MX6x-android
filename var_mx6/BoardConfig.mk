...
PRODUCT_COPY_FILES +=	\
	...
	device/variscite/var_mx6/fstab_emmc_dart.freescale:root/fstab_emmc_dart.freescale
...
USE_ATHR_GPS_HARDWARE :=
USE_QEMU_GPS_HARDWARE :=
...
BOARD_KERNEL_CMDLINE := console=ttymxc0,115200 init=/init video=mxcfb0:dev=ldb,bpp=32 video=mxcfb1:off video=mxcfb2:off video=mxcfb3:off vmalloc=256M androidboot.console=ttymxc0 consoleblank=0 androidboot.hardware=freescale cma=384M androidboot.dm_verity=disabled androidboot.selinux=disabled
